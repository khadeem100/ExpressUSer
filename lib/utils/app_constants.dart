...
class AppConstants {
  ...
  static const String appName = 'Express';
  ...
  static List<LanguageModel> languages = [
    ...
    LanguageModel(imageUrl: Images.nederlands, languageName: 'Nederlands', countryCode: 'NL', languageCode: 'nl'),
    LanguageModel(imageUrl: Images.surinaams, languageName: 'Surinaams', countryCode: 'Su', languageCode: 'su'),
  ];
